 ...
 * 
 * import graphql.GraphQL; import graphql.schema.GraphQLSchema; import
 * graphql.schema.idl.RuntimeWiring; import graphql.schema.idl.SchemaGenerator;
 * import graphql.schema.idl.SchemaParser; import
 * graphql.schema.idl.TypeDefinitionRegistry; import
 * graphql.schema.idl.TypeRuntimeWiring;
 * 
 * public class GrpahqlProvider {
 * 
 ...
 * Resources.getResource("schema.graphql"); String sdl = Resources.toString(url,
 * Charsets.UTF_8); GraphQLSchema graphQLSchema = buildSchema(sdl); this.graphQL
 * = GraphQL.newGraphQL(graphQLSchema).build(); }
 * 
 * @Autowired GrpahqlDataFetcher graphQLDataFetchers;
 * 
 ...
 * 
 * private RuntimeWiring buildWiring() { return RuntimeWiring.newRuntimeWiring()
 ...
 * graphQLDataFetchers.getAuthorDataFetcher()) .dataFetcher("pageCount",
 * graphQLDataFetchers.getPageCountDataFetcher()))
 * 
 * .build(); }
 * 
 * }
