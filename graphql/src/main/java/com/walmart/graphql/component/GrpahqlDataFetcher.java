 ...
 * 
 * 
 * @Component public class GrpahqlDataFetcher {
 * 
 * 
 * 
 ...
 * author.get("id").equals(authorId)) .findFirst() .orElse(null); }; } public
 * DataFetcher getPageCountDataFetcher() { return dataFetchingEnvironment -> {
 * Map<String,String> book = dataFetchingEnvironment.getSource(); return
 * book.get("totalPages"); }; }
 * 
 * }
 * 
